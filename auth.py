...
def login(): # define login page fucntion
    ...
    else: # if the request is POST, check if the user exist and with te right password
...
@auth.route('/signup', methods=['GET', 'POST'])  # define the sign up path
def signup(): # define the sign up function
    if request.method=='GET': # if the request is GET, return the sign up page and forms
        ...
        role = "user" #default role in signup
